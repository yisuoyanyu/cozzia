...
<div class="pageContent">
	<form method="post" action="../../jui/demo/common/ajaxDone.html" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>商品名称：</label>
				<input name="goodsname" type="text" size="30"  alt="请输入商品名称"/>
			</p>
			<p>
				<label>型号：</label>
				<input name="goodsversion" type="text" size="30"  alt="请输入商品型号"/>
			</p>
			<p>
				<label>价格：</label>
				<input name="goodsprice" type="text" size="30"  alt="请输入商品价格"/>
			</p>
			...
			<p>
				<label>颜色：</label>
				<input name="goodscolor" type="text" size="30"  alt="请输入商品颜色"/>
			</p>		
			<p>
				<label>备注：</label>
